...
@interface JourDetailController ()<UIActionSheetDelegate,UMSocialUIDelegate>
...
@implementation JourDetailController
...
-(void)addtitleView
{
    ...
    if (self.travelNotes != nil ) {
        ...
        dateLabel.text = [NSString stringWithFormat:@" %@,%@天,%@图  ",self.travelNotes.start_date,self.travelNotes.total_days,self.travelNotes.photo_number];
